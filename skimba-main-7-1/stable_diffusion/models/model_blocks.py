...
class Mapping2Dto3D(nn.Module):
    ...
    def __init__(self, bottleneck_size, dim_template, dim_output,hidden_neurons,  num_layers):
        # bottleneck_size, input_size, dim_output, hidden_neurons,  num_layers
        ...
        print(
            f"New MLP decoder : hidden size {hidden_neurons}, num_layers {num_layers}, activation {'relu'}")
